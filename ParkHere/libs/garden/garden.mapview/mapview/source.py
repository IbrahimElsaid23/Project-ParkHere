...
class MapSource(object):
    ...
    attribution_osm = 'Maps & Data © [i][ref=https://www.osm.org/copyright]OpenStreetMap contributors[/ref][/i]'
    attribution_thunderforest = 'Maps © [i][ref=https://www.thunderforest.com]Thunderforest[/ref][/i], Data © [i][ref=https://www.osm.org/copyright]OpenStreetMap contributors[/ref][/i]'

    # list of available providers
    # cache_key: (is_overlay, minzoom, maxzoom, url, attribution)
    providers = {
        "osm": (0, 0, 19, "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", attribution_osm),
        "osm-hot": (0, 0, 19, "https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png", ""),
        "osm-de": (0, 0, 18, "https://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png", "Tiles @ OSM DE"),
        "osm-fr": (0, 0, 20, "https://{s}.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png", "Tiles @ OSM France"),
        "cyclemap": (0, 0, 17, "https://{s}.tile.opencyclemap.org/cycle/{z}/{x}/{y}.png", "Tiles @ Andy Allan"),
        "thunderforest-cycle": (0, 0, 19, "https://{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png", attribution_thunderforest),
        "thunderforest-transport": (0, 0, 19, "https://{s}.tile.thunderforest.com/transport/{z}/{x}/{y}.png", attribution_thunderforest),
        "thunderforest-landscape": (0, 0, 19, "https://{s}.tile.thunderforest.com/landscape/{z}/{x}/{y}.png", attribution_thunderforest),
        "thunderforest-outdoors": (0, 0, 19, "https://{s}.tile.thunderforest.com/outdoors/{z}/{x}/{y}.png", attribution_thunderforest),
        
        # no longer available
        #"mapquest-osm": (0, 0, 19, "https://otile{s}.mqcdn.com/tiles/1.0.0/map/{z}/{x}/{y}.jpeg", "Tiles Courtesy of Mapquest", {"subdomains": "1234", "image_ext": "jpeg"}),
        #"mapquest-aerial": (0, 0, 19, "https://oatile{s}.mqcdn.com/tiles/1.0.0/sat/{z}/{x}/{y}.jpeg", "Tiles Courtesy of Mapquest", {"subdomains": "1234", "image_ext": "jpeg"}),
        
        # more to add with
        # https://github.com/leaflet-extras/leaflet-providers/blob/master/leaflet-providers.js
        # not working ?
        #"openseamap": (0, 0, 19, "https://tiles.openseamap.org/seamark/{z}/{x}/{y}.png",
